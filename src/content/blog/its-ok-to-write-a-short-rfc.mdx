...
- the root cause[^10]
[^10]: Technical postmortems also include how the issue was detected and resolved. See [this example of a postmortem](https://sre.google/sre-book/example-postmortem) at Google.
- the lessons learned
	- what went wrong
	- what went well
	- where we got lucky
